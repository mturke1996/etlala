        ...
        <Routes>
          ...
          >
            ...
            <Route
              path="/clients"
              element={
                <AppLockGuard module="clients" requireScreen>
                  <ClientsPage />
                </AppLockGuard>
              }
            />
            ...
            <Route
              path="/invoices"
              element={
                <AppLockGuard module="invoices" requireScreen>
                  <InvoicesPage />
                </AppLockGuard>
              }
            />
            ...
            <Route
              path="/expenses"
              element={
                <AppLockGuard module="expenses" requireScreen>
                  <ExpensesPage />
                </AppLockGuard>
              }
            />
            <Route
              path="/payments"
              element={
                <AppLockGuard module="payments" requireScreen>
                  <PaymentsPage />
                </AppLockGuard>
              }
            />
            <Route
              path="/debts"
              element={
                <AppLockGuard module="debts" requireScreen>
                  <DebtsPage />
                </AppLockGuard>
              }
            />
            <Route
              path="/users"
              element={
                <AppLockGuard module="users" requireScreen>
                  <UsersPage />
                </AppLockGuard>
              }
            />
            <Route
              path="/fund"
              element={
                <AppLockGuard module="balances" requireScreen>
                  <FundPage />
                </AppLockGuard>
              }
            />
            <Route
              path="/letters"
              element={
                <AppLockGuard module="letters" requireScreen>
                  <LettersPage />
                </AppLockGuard>
              }
            />
