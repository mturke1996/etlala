import { Box, Stack, Typography, Chip, Avatar, alpha, Divider } from '@mui/material';
...
export type ClientProfileHeroProps = {
  client: Client;
  /**
   * سطر نشاط مرجعي: أعداد فقط (فواتير، دفعات، سجلات…) — بدون مبالغ.
   * التفصيل المالي يبقى في بطاقة «الملخص» أسفل الهيدر.
   */
  activitySummary?: string;
};

/**
 * هوية العميل فقط — بلا تكرار للأرقام المالية (Swiss / bento: طبقة واحدة واضحة).
 */
      ...
      >
        ...
        >
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
            ...
            {activitySummary ? (
              <>
                <Divider sx={{ my: 1.25, borderColor: alpha('#fff', 0.1) }} />
                <Typography
                  variant="caption"
                  sx={{
                    color: alpha('#fff', 0.5),
