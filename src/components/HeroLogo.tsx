...
type HeroLogoProps = { size?: number; /** تخطٍ أقل للهيرو المدمج */ compact?: boolean };
    ...
    >
      ...
      <Box
        sx={{
          ...
          alignItems: 'center',
          justifyContent: 'center',
          background: 'linear-gradient(165deg, rgba(255,255,255,0.14) 0%, rgba(255,255,255,0.04) 45%, rgba(0,0,0,0.12) 100%)',
      ...
      >
        <Box
          sx={{
            ...
            inset: 0,
            borderRadius: '50%',
            background: 'radial-gradient(ellipse 70% 60% at 30% 20%, rgba(200, 192, 176, 0.2) 0%, transparent 55%)',
            pointerEvents: 'none',
          }}
        />
        <motion.div
          ...
          transition={reduce ? undefined : { duration: compact ? 5.2 : 4.2, repeat: Infinity, ease: 'easeInOut' }}
