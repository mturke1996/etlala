...
export const HomePage = () => {
  ...
  const { isLocked, isSessionUnlocked, canAccess, unlockedUsers } =
    useAppLockStore();
  ...
  const myFundStats = useMemo(() => {
    ...
    const allExp = [
      ...expenses.filter(
        (e) => e.userId === uid || (userName && e.createdBy === userName),
      ),
    ].sort((a, b) => dayjs(a.createdAt).diff(dayjs(b.createdAt)));
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        sx={{
          background:
            "linear-gradient(152deg, #0B1221 0%, #111C3A 28%, #0D1528 55%, #0A101D 100%)",
          ...
          boxShadow:
            "0 20px 56px -24px rgba(0,0,0,0.5), 0 0 0 1px rgba(226, 232, 240, 0.06), inset 0 -1px 0 rgba(226, 232, 240, 0.1)",
          ...
          "&::after": {
            ...
            height: "100px",
            background:
              "radial-gradient(ellipse at 50% 0%, rgba(200, 192, 176, 0.15) 0%, transparent 70%)",
            filter: "blur(30px)",
            pointerEvents: "none",
            zIndex: 0,
          },
      ...
      >
        ...
        <Box
          ...
          sx={{
            ...
            pointerEvents: "none",
            background:
              "linear-gradient(180deg, rgba(200, 192, 176, 0.03) 0%, transparent 72%)",
          }}
          aria-hidden
        />
        <Container maxWidth="sm" sx={{ position: "relative", zIndex: 1 }}>
          ...
          >
            ...
            <Stack
              ...
              spacing={1}
              alignItems="center"
              sx={{ color: "rgba(255,255,255,0.55)", direction: "ltr" }}
            >
          ...
          {canAccess("stats") && (
            <Box
              ...
              whileHover={
                reduceMotion
                  ? undefined
                  : { y: -3, boxShadow: "0 20px 50px -12px rgba(0,0,0,0.35)" }
              }
              ...
              >
                <Box
                  sx={{
                    ...
                    bottom: 0,
                    background:
                      "radial-gradient(circle at 100% 0%, rgba(212,197,163,0.15) 0%, transparent 50%)",
                    pointerEvents: "none",
                  }}
                />
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        ...
                        borderRadius: "50%",
                        background:
                          "linear-gradient(135deg, #d4c5a3 0%, #a3967a 100%)",
                        display: "flex",
                        alignItems: "center",
          ...
          {myFundStats &&
            (() => {
              ...
              const pct =
                myFundStats.deposited > 0
                  ? Math.max(
                      0,
                      Math.min(
                        100,
                        (myFundStats.remaining / myFundStats.deposited) * 100,
                      ),
                    )
                  : 0;
              return (
                ...
                >
                  ...
                  >
                    <Box>
                      ...
                      >
                        {isNeg
                          ? `-${formatCurrency(Math.abs(myFundStats.remaining))}`
                  ...
                  >
                    {[
                      {
                        label: "عدد العهدات",
                        value: String(myFundStats.count),
                        color: "#fff",
                      },
                      {
                        label: "إجمالي العهدات",
                        value: formatCurrency(myFundStats.deposited),
                        color: "#fff",
                      },
                      {
                        label: "المصروفات",
                        value: formatCurrency(myFundStats.spent),
                        color: "#fca5a5",
                      },
                      {
                        label: "المتبقي",
                  ...
                  {isNeg && (
                    <Box
                      sx={{
                        background:
                          "linear-gradient(90deg, rgba(225,29,72,0.2) 0%, rgba(225,29,72,0.1) 100%)",
                    ...
                    >
                      <WarningAmber
                        sx={{ fontSize: 22, color: "#fca5a5", flexShrink: 0 }}
                      />
                      <Box>
                        <Typography
                          sx={{
        ...
        <Stack spacing={1.1}>
          {menuItems.map((item, index) => (
            <Box
              ...
              sx={{
                width: 1,
                "@media (prefers-reduced-motion: reduce)": { y: 0 },
              }}
            >
              <EtlalaNavRow
                title={item.title}
                ...
                onClick={() => navigate(item.path)}
                  ...
                  <ChevronLeft
                    sx={{ color: "text.secondary", opacity: 0.4, fontSize: 22 }}
                  />
                }
              />
            </Box>
        ...
        {showFund && (
          <Box
            ...
            whileHover={
              reduceMotion
                ? undefined
                : { y: -3, boxShadow: "0 12px 32px rgba(0,0,0,0.12)" }
            }
            ...
            sx={{
              ...
              borderInlineStartColor: fundIsEmpty
                ? "#d64545"
                : fundIsLow
                  ? "#f59e0b"
                  : "#0d9668",
                    ...
                    sx={{
                      ...
                      bgcolor: fundIsEmpty
                        ...
                        : fundIsLow
                          ? "rgba(245,158,11,0.1)"
                          : "rgba(13,150,104,0.1)",
                      border: `1px solid ${fundIsEmpty ? "rgba(214,69,69,0.22)" : fundIsLow ? "rgba(245,158,11,0.22)" : "rgba(13,150,104,0.2)"}`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      flexShrink: 0,
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      ...
                      sx={{
                        color:
                          myFundStats.remaining > 0 ? "#0d9668" : "#d64545",
                        fontFamily: "Outfit, sans-serif",
                      }}
                    >
                      {formatCurrency(myFundStats.remaining)}
                  ...
                  <LinearProgress
                    ...
                    sx={{
                      ...
                      "& .MuiLinearProgress-bar": {
                        background:
                          myFundStats.remaining > myFundStats.deposited * 0.3
