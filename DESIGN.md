...
- في النصوص الظاهرة للمستخدم، **صافي النسبة** هو المصطلح الموحّد بدل «الربح» لخط المكسب/العمولة المحسوبة من المدفوعات.  
- بطاقة الرئيسية تعرض **المبلغ الكامل (د.ل)** لصافي النسبة مع سطر ثانٍ اختياري لـ **هامش من المحصّل %**.
