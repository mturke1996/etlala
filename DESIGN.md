...
- Container: `maxWidth="sm"` للتطبيق المحمول أولاً؛ على سطح المكتب (`≥1200px`) المحتوى `xl`.  
- شريط سفلي ثابت: 70px + safe area — **جوال فقط**.  
- **سطح المكتب:** شريط جانبي فاتح 260px ثابت (`DesktopSidebar` لا يتحرك مع التمرير) + هيدر أوامر مسطّح لاصق + الرئيسية: هيرو كبير بجانب النبض/التوزيع ثم المؤشرات ثم التحليل بعرض كامل ثم القوائم.
